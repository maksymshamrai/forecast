        ...
        <>
            <div className="weather">
                <div className="card">
                    ...
                    <img className="weather-image" src={`https://openweathermap.org/img/wn/${icon}@2x.png`}alt="" />
                    <p className="temp">{Math.round(weather.main.temp)}℃</p>
                    <div className="btn-container">
                        <button className="refresh-btn" onClick={fetchWeather}><img src={refreshIcon} alt="" /></button>
